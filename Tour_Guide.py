...
CLIENT_ID     = '__________________' # your Foursquare ID
CLIENT_SECRET = '__________________' # your Foursquare Secret
ACCESS_TOKEN  = '__________________' # your FourSquare Access Token
VERSION = '20180604'
...
res                = venues(latitude,longitude)      # Find the venues around that Location 
...
res                = venues_tre(latitude,longitude)      # Find the venues of that catagory 
mapobj1=folium.Map(location=[latitude,longitude],zoom_start=14) # Its Blank Canvass of Map
folium.Marker(location=[latitude,longitude],popup="Estimated Location",tooltip="Added Location",icon=folium.CustomIcon(icon_image="C:/Users/Abdul Rehman/loc.gif")).add_to(mapobj1)
